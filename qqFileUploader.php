...
class qqFileUploader {
    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        $pathinfo = $this->mb_pathinfo($name);
        ...
        if ($totalParts > 1){
            ...
            if ($success AND ($totalParts-1 == $partIndex)){
                ...
                $this->uploadName = $this->mb_basename($target);
    ...
    protected function getUniqueTargetPath($uploadDirectory, $filename)
    {
        ...
        $pathinfo = $this->mb_pathinfo($filename);
    ...
    protected function mb_pathinfo($filepath) {
    ...
    protected function mb_basename($filename) {
        $pathinfo = $this->mb_pathinfo($filename);
